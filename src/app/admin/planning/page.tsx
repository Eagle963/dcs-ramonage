    ...
    <div>
      ...
      {viewType === 'map' && (
        <div className="grid lg:grid-cols-12 gap-4">
          {/* Panneau gauche - Liste (plus petit) */}
          ...
          {/* Panneau droite - Carte (plus grande, carrée) */}
          <div className="lg:col-span-8">
            <div className="bg-white rounded-xl border border-secondary-100 overflow-hidden aspect-square relative">
              {/* Légende */}
