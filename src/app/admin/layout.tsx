...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-secondary-50">
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 z-50 h-full bg-white border-r border-secondary-200 transition-all duration-300 ${
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-secondary-200">
          ...
          <button onClick={() => setSidebarOpen(!sidebarOpen)} className="p-1 hover:bg-secondary-100 rounded lg:block hidden">
          ...
          <div className="relative">
            ...
            {showUserMenu && sidebarOpen && (
              <div className="absolute bottom-full left-0 w-full mb-2 bg-white border border-secondary-200 rounded-lg shadow-lg py-1">
                <Link href="/admin/entreprise" className="flex items-center gap-2 px-4 py-2 text-sm text-secondary-600 hover:bg-secondary-50">
                  <Building2 className="w-4 h-4" />
                  Mon entreprise
                </Link>
                <Link href="/admin/parametres" className="flex items-center gap-2 px-4 py-2 text-sm text-secondary-600 hover:bg-secondary-50">
        ...
        <header className="h-16 bg-white border-b border-secondary-200 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold text-secondary-900 hidden sm:block">
              ...
              {pathname === '/admin/planning' && 'Planning'}
              {pathname === '/admin/demandes' && 'Demandes'}
              {pathname === '/admin/clients' && 'Clients'}
              {pathname === '/admin/devis' && 'Devis'}
              {pathname === '/admin/factures' && 'Factures'}
              {pathname === '/admin/parametres' && 'Paramètres'}
            </h1>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Quick actions */}
            <button className="hidden sm:flex items-center gap-2 px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600">
